...
def calculate_p():    #This function calculates the momentum of a particle given its components.
    pass       #uses the formula for p

def calculate_pT ():    #This function calculates the transverse momentum of a particle given its x and y components.    
    pass
